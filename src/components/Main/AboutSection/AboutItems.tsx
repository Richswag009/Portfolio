    ...
    <>
      ...
      <div className="flex items-center justify-center flex-col lg:flex-row  lg:space-x-10 ">
        ...
        <div className="text lg:flex-[45%]">
          <motion.h1
            className="font-normal text-cyan text-xl lg:text-2xl font-pop flex items-start space-x-2 lg:space-x-3 mb-6"
          ...
          <div className="mb-10 md:mb-12 lg:mb-0">
            <motion.p
              ...
              viewport={{ once: true }}
            >
              A graduate of Mechanical Engineering transitioning ,{" "}
              <span className="text-cyan">self-taught </span>
              to Full-Stack Development with a passion and love for coding and
              solving problems that impact the lives of people. I can develop
              modern responsive websites from scratch and build them into
              user-friendly and accessible web experiences for your users.
            </motion.p>
            <motion.p
              className="font-normal text-lg text-text lg:text-xl mb-6"
              variants={aboutVariant}
        ...
        >
          <div className="w-full md:w-full h-[28rem] md:h-[37rem] lg:h-[30rem] xl:h-[34rem] relative rounded-md overflow-hidden border-2 border-cyan backdrop-blur-sm bg-cyan/20 z-20 ">
            <div className=" duration-500 w-full h-full relative">
              <Image
                src={"/images/me.jpg"}
                alt="about image"
                priority={true}
